...
class GazeboEnv(gym.Env):
    ...
    def __init__(self, launchfile):
        ...
        my_env["GAZEBO_MODEL_PATH"] = os.path.join(os.path.dirname(__file__), "assets", "models") \
                                    + my_env["GAZEBO_MODEL_PATH"]
        my_env["GYM_GAZEBO_WORLD_CIRCUIT2"] = os.path.join(os.path.dirname(__file__), "assets", "worlds", "circuit2.world")
        print(my_env["GAZEBO_MODEL_PATH"])
        print(my_env["GYM_GAZEBO_WORLD_CIRCUIT2"])
        self._roslaunch = subprocess.Popen([sys.executable,
